package com.gogidix.infrastructure.dashboard-integrationservice;
...
@ActiveProfiles("test")
@DisplayName("DashboardIntegrationService Service Tests")
class DashboardIntegrationServiceServiceTest {
