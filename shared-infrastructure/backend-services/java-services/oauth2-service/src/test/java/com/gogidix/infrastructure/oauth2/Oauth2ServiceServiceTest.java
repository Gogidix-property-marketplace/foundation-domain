...
@SpringBootTest(classes = com.gogidix.infrastructure.oauth2.MainApplication.class, webEnvironment = SpringBootTest.WebEnvironment.RANDOM_PORT)
@ActiveProfiles("test")
@DisplayName("Oauth2Service Service Tests")
class Oauth2ServiceServiceTest {
