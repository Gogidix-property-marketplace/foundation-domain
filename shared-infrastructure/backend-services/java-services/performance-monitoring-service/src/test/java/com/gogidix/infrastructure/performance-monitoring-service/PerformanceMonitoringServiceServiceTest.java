package com.gogidix.infrastructure.performance-monitoringservice;
...
@ActiveProfiles("test")
@DisplayName("PerformanceMonitoringService Service Tests")
class PerformanceMonitoringServiceServiceTest {
