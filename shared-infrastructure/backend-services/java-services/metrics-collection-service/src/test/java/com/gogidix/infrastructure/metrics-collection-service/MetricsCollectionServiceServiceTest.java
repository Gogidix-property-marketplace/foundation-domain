package com.gogidix.infrastructure.metrics-collectionservice;
...
@ActiveProfiles("test")
@DisplayName("MetricsCollectionService Service Tests")
class MetricsCollectionServiceServiceTest {
