package com.gogidix.infrastructure.security-compliance-service;
...
@ActiveProfiles("test")
@DisplayName("SecurityComplianceService Service Tests")
class SecurityComplianceServiceServiceTest {
