package com.gogidix.infrastructure.distributed-tracing-service;
...
@ActiveProfiles("test")
@DisplayName("DistributedTracingService Service Tests")
class DistributedTracingServiceServiceTest {
