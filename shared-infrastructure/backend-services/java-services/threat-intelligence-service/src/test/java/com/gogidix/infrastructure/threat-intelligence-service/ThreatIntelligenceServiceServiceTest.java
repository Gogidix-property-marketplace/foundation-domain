package com.gogidix.infrastructure.threat-intelligence-service;
...
@ActiveProfiles("test")
@DisplayName("ThreatIntelligenceService Service Tests")
class ThreatIntelligenceServiceServiceTest {
