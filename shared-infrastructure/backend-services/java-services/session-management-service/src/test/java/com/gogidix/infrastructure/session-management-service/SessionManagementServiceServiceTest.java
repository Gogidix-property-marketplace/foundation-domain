package com.gogidix.infrastructure.session-management-service;
...
@ActiveProfiles("test")
@DisplayName("SessionManagementService Service Tests")
class SessionManagementServiceServiceTest {
