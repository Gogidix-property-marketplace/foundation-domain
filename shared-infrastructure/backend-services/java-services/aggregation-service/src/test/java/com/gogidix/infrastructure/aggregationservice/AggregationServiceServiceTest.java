package com.gogidix.infrastructure.aggregationserviceservice;
...
@SpringBootTest(classes = com.gogidix.infrastructure.aggregationservice.MainApplication.class, webEnvironment = SpringBootTest.WebEnvironment.RANDOM_PORT)
@ActiveProfiles("test")
@DisplayName("AggregationService Service Tests")
class AggregationServiceServiceTest {
