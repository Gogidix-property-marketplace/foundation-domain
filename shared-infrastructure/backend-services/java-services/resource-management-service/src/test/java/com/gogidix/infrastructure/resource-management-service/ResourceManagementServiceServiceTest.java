package com.gogidix.infrastructure.resource-management-service;
...
@ActiveProfiles("test")
@DisplayName("ResourceManagementService Service Tests")
class ResourceManagementServiceServiceTest {
