...
@SpringBootTest(classes = com.gogidix.infrastructure.gateway.MainApplication.class, webEnvironment = SpringBootTest.WebEnvironment.RANDOM_PORT)
@ActiveProfiles("test")
@DisplayName("ApiGateway Service Tests")
