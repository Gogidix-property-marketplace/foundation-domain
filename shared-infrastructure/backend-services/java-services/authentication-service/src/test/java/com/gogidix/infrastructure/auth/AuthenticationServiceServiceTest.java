...
@SpringBootTest(classes = com.gogidix.infrastructure.auth.MainApplication.class, webEnvironment = SpringBootTest.WebEnvironment.RANDOM_PORT)
@ActiveProfiles("test")
@DisplayName("AuthenticationService Service Tests")
class AuthenticationServiceServiceTest {
