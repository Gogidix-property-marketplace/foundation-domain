package com.gogidix.infrastructure.resource-allocation-service;
...
@ActiveProfiles("test")
@DisplayName("ResourceAllocationService Service Tests")
class ResourceAllocationServiceServiceTest {
