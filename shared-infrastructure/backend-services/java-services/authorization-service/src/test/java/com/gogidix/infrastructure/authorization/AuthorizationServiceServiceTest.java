...
@SpringBootTest(classes = com.gogidix.infrastructure.authorization.MainApplication.class, webEnvironment = SpringBootTest.WebEnvironment.RANDOM_PORT)
@ActiveProfiles("test")
@DisplayName("AuthorizationService Service Tests")
class AuthorizationServiceServiceTest {
