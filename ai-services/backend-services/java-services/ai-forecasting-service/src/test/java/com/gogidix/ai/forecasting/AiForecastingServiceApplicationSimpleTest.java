package com.gogidix.ai.forecasting;
...
/**
 * Simple unit tests for ai-forecasting-service
 * These tests provide basic coverage without Spring context
 */
class AiForecastingServiceApplicationSimpleTest {
    ...
    class ServiceStructureTests {
        ...
        void servicePackageShouldBeCorrect() {
            Package pkg = Package.getPackage("com.gogidix.ai.forecasting");
            assertNotNull(pkg, "Package should exist");
            assertEquals("com.gogidix.ai.forecasting", pkg.getName());
        }

        @Test
        @DisplayName("Test class should be instantiatable")
        void testClassShouldBeInstantiatable() {
            AiForecastingServiceApplicationSimpleTest test = new AiForecastingServiceApplicationSimpleTest();
        ...
        void testClassShouldHaveCorrectPackage() {
            assertEquals("com.gogidix.ai.forecasting",
                AiForecastingServiceApplicationSimpleTest.class.getPackage().getName());
        }
        ...
        void testClassShouldNotBeAbstract() {
            assertFalse(java.lang.reflect.Modifier.isAbstract(
                AiForecastingServiceApplicationSimpleTest.class.getModifiers()));
        }
    }

    @Nested
    @DisplayName("AI Forecasting Service Operations Tests")
