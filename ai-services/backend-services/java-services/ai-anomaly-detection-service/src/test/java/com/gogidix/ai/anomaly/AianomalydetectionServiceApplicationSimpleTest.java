package com.gogidix.ai.anomaly;
...
/**
 * Simple unit tests for ai-anomaly-detection-service
 * These tests provide basic coverage without Spring context
 */
class AiAnomalyDetectionServiceApplicationSimpleTest {
    ...
    class ServiceStructureTests {
        ...
        void servicePackageShouldBeCorrect() {
            Package pkg = Package.getPackage("com.gogidix.ai.anomaly");
            assertNotNull(pkg, "Package should exist");
            assertEquals("com.gogidix.ai.anomaly", pkg.getName());
        }

        @Test
        @DisplayName("Test class should be instantiatable")
        void testClassShouldBeInstantiatable() {
            AiAnomalyDetectionServiceApplicationSimpleTest test = new AiAnomalyDetectionServiceApplicationSimpleTest();
        ...
        void testClassShouldHaveCorrectPackage() {
            assertEquals("com.gogidix.ai.anomaly",
                AiAnomalyDetectionServiceApplicationSimpleTest.class.getPackage().getName());
        }
        ...
        void testClassShouldNotBeAbstract() {
            assertFalse(java.lang.reflect.Modifier.isAbstract(
                AiAnomalyDetectionServiceApplicationSimpleTest.class.getModifiers()));
        }
    }

    @Nested
    @DisplayName("AI Anomaly Detection Operations Tests")
