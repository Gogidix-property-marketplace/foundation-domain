...
@SpringBootTest
@ActiveProfiles("test")
@DisplayName("AiAnomalyDetectionServiceApplicationSimpleTest")
public class AiAnomalyDetectionServiceApplicationSimpleTest {

    private static final String SERVICE_NAME = "ai-anomaly-detection-service";
    private static final String ARTIFACT_ID = "ai-anomaly-detection";
    ...
    class ServiceStructureTests {
        ...
        void applicationClassShouldBeLoadable() {
            assertDoesNotThrow(() -> {
                Class.forName("com.gogidix.ai.service.AiAnomalyDetectionServiceApplicationSimpleTest");
            });
        }
    }
    ...
    class IntegrationTests {
        ...
        void shouldStartApplicationContext() {
            assertDoesNotThrow(() -> {
                SpringApplication.run(AiAnomalyDetectionServiceApplicationSimpleTest.class);
            });
        }
