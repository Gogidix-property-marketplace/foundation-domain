...
/**
 * Simple unit tests for ai-speech-recognition-service
 * These tests provide basic coverage without Spring context
 */
class AiSpeechRecognitionServiceApplicationSimpleTest {
    ...
    class ServiceStructureTests {
        ...
        void servicePackageShouldBeCorrect() {
            Package pkg = Package.getPackage("com.gogidix.ai.speech");
            assertNotNull(pkg, "Package should exist");
            assertEquals("com.gogidix.ai.speech", pkg.getName());
        }

        @Test
        @DisplayName("Test class should be instantiatable")
        void testClassShouldBeInstantiatable() {
            AiSpeechRecognitionServiceApplicationSimpleTest test = new AiSpeechRecognitionServiceApplicationSimpleTest();
        ...
        void testClassShouldHaveCorrectPackage() {
            assertEquals("com.gogidix.ai.speech",
                AiSpeechRecognitionServiceApplicationSimpleTest.class.getPackage().getName());
        }
        ...
        void testClassShouldNotBeAbstract() {
            assertFalse(java.lang.reflect.Modifier.isAbstract(
                AiSpeechRecognitionServiceApplicationSimpleTest.class.getModifiers()));
        }
    }

    @Nested
    @DisplayName("AI Speech Recognition Operations Tests")
