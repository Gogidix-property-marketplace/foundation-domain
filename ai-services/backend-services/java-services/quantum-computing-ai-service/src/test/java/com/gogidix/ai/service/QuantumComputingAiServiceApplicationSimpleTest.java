...
@SpringBootTest
@ActiveProfiles("test")
@DisplayName("QuantumComputingAiServiceApplicationSimpleTest")
public class QuantumComputingAiServiceApplicationSimpleTest {

    private static final String SERVICE_NAME = "quantum-computing-ai-service";
    private static final String ARTIFACT_ID = "quantum-computing-ai";
    ...
    class ServiceStructureTests {
        ...
        void applicationClassShouldBeLoadable() {
            assertDoesNotThrow(() -> {
                Class.forName("com.gogidix.ai.service.QuantumComputingAiServiceApplicationSimpleTest");
            });
        }
    }
    ...
    class IntegrationTests {
        ...
        void shouldStartApplicationContext() {
            assertDoesNotThrow(() -> {
                SpringApplication.run(QuantumComputingAiServiceApplicationSimpleTest.class);
            });
        }
