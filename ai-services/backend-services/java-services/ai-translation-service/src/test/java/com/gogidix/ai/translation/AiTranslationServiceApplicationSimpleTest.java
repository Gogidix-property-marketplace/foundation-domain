...
/**
 * Simple unit tests for ai-translation-service
 * These tests provide basic coverage without Spring context
 */
class AiTranslationServiceApplicationSimpleTest {
    ...
    class ServiceStructureTests {
        ...
        void testClassShouldBeInstantiatable() {
            AiTranslationServiceApplicationSimpleTest test = new AiTranslationServiceApplicationSimpleTest();
        ...
        void testClassShouldHaveCorrectPackage() {
            assertEquals("com.gogidix.ai.translation",
                AiTranslationServiceApplicationSimpleTest.class.getPackage().getName());
        }
        ...
        void testClassShouldNotBeAbstract() {
            assertFalse(java.lang.reflect.Modifier.isAbstract(
                AiTranslationServiceApplicationSimpleTest.class.getModifiers()));
        }
    }

    @Nested
    @DisplayName("AI Translation Service Operations Tests")
