...
@SpringBootTest
@ActiveProfiles("test")
@DisplayName("VoiceImageRecognitionAiServiceApplicationSimpleTest")
public class VoiceImageRecognitionAiServiceApplicationSimpleTest {

    private static final String SERVICE_NAME = "voice-image-recognition-ai-service";
    private static final String ARTIFACT_ID = "voice-image-recognition-ai";
    ...
    class ServiceStructureTests {
        ...
        void applicationClassShouldBeLoadable() {
            assertDoesNotThrow(() -> {
                Class.forName("com.gogidix.ai.service.VoiceImageRecognitionAiServiceApplicationSimpleTest");
            });
        }
    }
    ...
    class IntegrationTests {
        ...
        void shouldStartApplicationContext() {
            assertDoesNotThrow(() -> {
                SpringApplication.run(VoiceImageRecognitionAiServiceApplicationSimpleTest.class);
            });
        }
