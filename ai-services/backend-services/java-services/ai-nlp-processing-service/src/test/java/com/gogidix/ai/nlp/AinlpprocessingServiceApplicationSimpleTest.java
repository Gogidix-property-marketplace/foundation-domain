...
/**
 * Simple unit tests for ai-nlp-processing-service
 * These tests provide basic coverage without Spring context
 */
class AinlpprocessingServiceApplicationSimpleTest {
    ...
    class ServiceStructureTests {
        ...
        void servicePackageShouldBeCorrect() {
            Package pkg = Package.getPackage("com.gogidix.ai.nlp");
            assertNotNull(pkg, "Package should exist");
            assertEquals("com.gogidix.ai.nlp", pkg.getName());
        }

        @Test
        @DisplayName("Test class should be instantiatable")
        void testClassShouldBeInstantiatable() {
            AinlpprocessingServiceApplicationSimpleTest test = new AinlpprocessingServiceApplicationSimpleTest();
        ...
        void testClassShouldHaveCorrectPackage() {
            assertEquals("com.gogidix.ai.nlp",
                AinlpprocessingServiceApplicationSimpleTest.class.getPackage().getName());
        }
        ...
        void testClassShouldNotBeAbstract() {
            assertFalse(java.lang.reflect.Modifier.isAbstract(
                AinlpprocessingServiceApplicationSimpleTest.class.getModifiers()));
        }
    }

    @Nested
    @DisplayName("AI NLP Processing Operations Tests")
