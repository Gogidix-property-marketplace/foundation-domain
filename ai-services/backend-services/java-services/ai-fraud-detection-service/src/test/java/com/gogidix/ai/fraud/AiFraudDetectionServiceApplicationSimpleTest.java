...
/**
 * Simple unit tests for ai-fraud-detection-service
 * These tests provide basic coverage without Spring context
 */
class AiFraudDetectionServiceApplicationSimpleTest {
    ...
    class ServiceStructureTests {
        ...
        void servicePackageShouldBeCorrect() {
            Package pkg = Package.getPackage("com.gogidix.ai.fraud");
            assertNotNull(pkg, "Package should exist");
            assertEquals("com.gogidix.ai.fraud", pkg.getName());
        }

        @Test
        @DisplayName("Test class should be instantiatable")
        void testClassShouldBeInstantiatable() {
            AiFraudDetectionServiceApplicationSimpleTest test = new AiFraudDetectionServiceApplicationSimpleTest();
        ...
        void testClassShouldHaveCorrectPackage() {
            assertEquals("com.gogidix.ai.fraud",
                AiFraudDetectionServiceApplicationSimpleTest.class.getPackage().getName());
        }
        ...
        void testClassShouldNotBeAbstract() {
            assertFalse(java.lang.reflect.Modifier.isAbstract(
                AiFraudDetectionServiceApplicationSimpleTest.class.getModifiers()));
        }
    }

    @Nested
    @DisplayName("AI Fraud Detection Operations Tests")
