...
@SpringBootTest
@ActiveProfiles("test")
@DisplayName("LeadConversionAiServiceApplicationSimpleTest")
public class LeadConversionAiServiceApplicationSimpleTest {

    private static final String SERVICE_NAME = "lead-conversion-ai-service";
    private static final String ARTIFACT_ID = "lead-conversion-ai";
    ...
    class ServiceStructureTests {
        ...
        void applicationClassShouldBeLoadable() {
            assertDoesNotThrow(() -> {
                Class.forName("com.gogidix.ai.service.LeadConversionAiServiceApplicationSimpleTest");
            });
        }
    }
    ...
    class IntegrationTests {
        ...
        void shouldStartApplicationContext() {
            assertDoesNotThrow(() -> {
                SpringApplication.run(LeadConversionAiServiceApplicationSimpleTest.class);
            });
        }
