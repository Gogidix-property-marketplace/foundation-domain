package com.gogidix.ai.leadconversion;
...
/**
 * Simple unit tests for lead-conversion-ai-service
 * These tests provide basic coverage without Spring context
 */
class LeadConversionServiceApplicationSimpleTest {
    ...
    class ServiceStructureTests {
        ...
        void servicePackageShouldBeCorrect() {
            Package pkg = Package.getPackage("com.gogidix.ai.leadconversion");
            assertNotNull(pkg, "Package should exist");
            assertEquals("com.gogidix.ai.leadconversion", pkg.getName());
        }

        @Test
        @DisplayName("Test class should be instantiatable")
        void testClassShouldBeInstantiatable() {
            LeadConversionServiceApplicationSimpleTest test = new LeadConversionServiceApplicationSimpleTest();
        ...
        void testClassShouldHaveCorrectPackage() {
            assertEquals("com.gogidix.ai.leadconversion",
                LeadConversionServiceApplicationSimpleTest.class.getPackage().getName());
        }
        ...
        void testClassShouldNotBeAbstract() {
            assertFalse(java.lang.reflect.Modifier.isAbstract(
                LeadConversionServiceApplicationSimpleTest.class.getModifiers()));
        }
    }

    @Nested
    @DisplayName("Lead Conversion AI Operations Tests")
