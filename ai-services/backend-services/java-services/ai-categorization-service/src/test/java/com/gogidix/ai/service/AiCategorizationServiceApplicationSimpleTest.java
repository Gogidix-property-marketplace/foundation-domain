...
@SpringBootTest
@ActiveProfiles("test")
@DisplayName("AiCategorizationServiceApplicationSimpleTest")
public class AiCategorizationServiceApplicationSimpleTest {

    private static final String SERVICE_NAME = "ai-categorization-service";
    private static final String ARTIFACT_ID = "ai-categorization";
    ...
    class ServiceStructureTests {
        ...
        void applicationClassShouldBeLoadable() {
            assertDoesNotThrow(() -> {
                Class.forName("com.gogidix.ai.service.AiCategorizationServiceApplicationSimpleTest");
            });
        }
    }
    ...
    class IntegrationTests {
        ...
        void shouldStartApplicationContext() {
            assertDoesNotThrow(() -> {
                SpringApplication.run(AiCategorizationServiceApplicationSimpleTest.class);
            });
        }
