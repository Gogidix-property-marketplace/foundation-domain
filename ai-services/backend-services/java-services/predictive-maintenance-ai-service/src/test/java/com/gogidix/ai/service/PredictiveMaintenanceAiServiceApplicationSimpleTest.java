...
@SpringBootTest
@ActiveProfiles("test")
@DisplayName("PredictiveMaintenanceAiServiceApplicationSimpleTest")
public class PredictiveMaintenanceAiServiceApplicationSimpleTest {

    private static final String SERVICE_NAME = "predictive-maintenance-ai-service";
    private static final String ARTIFACT_ID = "predictive-maintenance-ai";
    ...
    class ServiceStructureTests {
        ...
        void applicationClassShouldBeLoadable() {
            assertDoesNotThrow(() -> {
                Class.forName("com.gogidix.ai.service.PredictiveMaintenanceAiServiceApplicationSimpleTest");
            });
        }
    }
    ...
    class IntegrationTests {
        ...
        void shouldStartApplicationContext() {
            assertDoesNotThrow(() -> {
                SpringApplication.run(PredictiveMaintenanceAiServiceApplicationSimpleTest.class);
            });
        }
