...
@SpringBootTest
@ActiveProfiles("test")
@DisplayName("ProcessMiningAiServiceApplicationSimpleTest")
public class ProcessMiningAiServiceApplicationSimpleTest {

    private static final String SERVICE_NAME = "process-mining-ai-service";
    private static final String ARTIFACT_ID = "process-mining-ai";
    ...
    class ServiceStructureTests {
        ...
        void applicationClassShouldBeLoadable() {
            assertDoesNotThrow(() -> {
                Class.forName("com.gogidix.ai.service.ProcessMiningAiServiceApplicationSimpleTest");
            });
        }
    }
    ...
    class IntegrationTests {
        ...
        void shouldStartApplicationContext() {
            assertDoesNotThrow(() -> {
                SpringApplication.run(ProcessMiningAiServiceApplicationSimpleTest.class);
            });
        }
