package com.gogidix.ai.dataquality;
...
/**
 * Simple unit tests for ai-data-quality-service
 * These tests provide basic coverage without Spring context
 */
class AiDataQualityServiceApplicationSimpleTest {
    ...
    class ServiceStructureTests {
        ...
        void servicePackageShouldBeCorrect() {
            Package pkg = Package.getPackage("com.gogidix.ai.dataquality");
            assertNotNull(pkg, "Package should exist");
            assertEquals("com.gogidix.ai.dataquality", pkg.getName());
        }

        @Test
        @DisplayName("Test class should be instantiatable")
        void testClassShouldBeInstantiatable() {
            AiDataQualityServiceApplicationSimpleTest test = new AiDataQualityServiceApplicationSimpleTest();
        ...
        void testClassShouldHaveCorrectPackage() {
            assertEquals("com.gogidix.ai.dataquality",
                AiDataQualityServiceApplicationSimpleTest.class.getPackage().getName());
        }
        ...
        void testClassShouldNotBeAbstract() {
            assertFalse(java.lang.reflect.Modifier.isAbstract(
                AiDataQualityServiceApplicationSimpleTest.class.getModifiers()));
        }
    }

    @Nested
    @DisplayName("AI Data Quality Operations Tests")
