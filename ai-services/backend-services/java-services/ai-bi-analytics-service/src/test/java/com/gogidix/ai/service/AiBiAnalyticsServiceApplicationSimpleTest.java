...
@SpringBootTest
@ActiveProfiles("test")
@DisplayName("AiBiAnalyticsServiceApplicationSimpleTest")
public class AiBiAnalyticsServiceApplicationSimpleTest {

    private static final String SERVICE_NAME = "ai-bi-analytics-service";
    private static final String ARTIFACT_ID = "ai-bi-analytics";
    ...
    class ServiceStructureTests {
        ...
        void applicationClassShouldBeLoadable() {
            assertDoesNotThrow(() -> {
                Class.forName("com.gogidix.ai.service.AiBiAnalyticsServiceApplicationSimpleTest");
            });
        }
    }
    ...
    class IntegrationTests {
        ...
        void shouldStartApplicationContext() {
            assertDoesNotThrow(() -> {
                SpringApplication.run(AiBiAnalyticsServiceApplicationSimpleTest.class);
            });
        }
