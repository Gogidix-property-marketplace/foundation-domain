...
@SpringBootTest
@ActiveProfiles("test")
@DisplayName("BlockchainAiServiceApplicationSimpleTest")
public class BlockchainAiServiceApplicationSimpleTest {

    private static final String SERVICE_NAME = "blockchain-ai-service";
    private static final String ARTIFACT_ID = "blockchain-ai";
    ...
    class ServiceStructureTests {
        ...
        void applicationClassShouldBeLoadable() {
            assertDoesNotThrow(() -> {
                Class.forName("com.gogidix.ai.service.BlockchainAiServiceApplicationSimpleTest");
            });
        }
    }
    ...
    class IntegrationTests {
        ...
        void shouldStartApplicationContext() {
            assertDoesNotThrow(() -> {
                SpringApplication.run(BlockchainAiServiceApplicationSimpleTest.class);
            });
        }
