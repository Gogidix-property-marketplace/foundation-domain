...
@SpringBootTest
@ActiveProfiles("test")
@DisplayName("CapacityPlanningAiServiceApplicationSimpleTest")
public class CapacityPlanningAiServiceApplicationSimpleTest {

    private static final String SERVICE_NAME = "capacity-planning-ai-service";
    private static final String ARTIFACT_ID = "capacity-planning-ai";
    ...
    class ServiceStructureTests {
        ...
        void applicationClassShouldBeLoadable() {
            assertDoesNotThrow(() -> {
                Class.forName("com.gogidix.ai.service.CapacityPlanningAiServiceApplicationSimpleTest");
            });
        }
    }
    ...
    class IntegrationTests {
        ...
        void shouldStartApplicationContext() {
            assertDoesNotThrow(() -> {
                SpringApplication.run(CapacityPlanningAiServiceApplicationSimpleTest.class);
            });
        }
