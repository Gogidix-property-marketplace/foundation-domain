package com.gogidix.ai.capacity;
...
/**
 * Simple unit tests for capacity-planning-ai-service
 * These tests provide basic coverage without Spring context
 */
class CapacityPlanningServiceApplicationSimpleTest {
    ...
    class ServiceStructureTests {
        ...
        void servicePackageShouldBeCorrect() {
            Package pkg = Package.getPackage("com.gogidix.ai.capacity");
            assertNotNull(pkg, "Package should exist");
            assertEquals("com.gogidix.ai.capacity", pkg.getName());
        }

        @Test
        @DisplayName("Test class should be instantiatable")
        void testClassShouldBeInstantiatable() {
            CapacityPlanningServiceApplicationSimpleTest test = new CapacityPlanningServiceApplicationSimpleTest();
        ...
        void testClassShouldHaveCorrectPackage() {
            assertEquals("com.gogidix.ai.capacity",
                CapacityPlanningServiceApplicationSimpleTest.class.getPackage().getName());
        }
        ...
        void testClassShouldNotBeAbstract() {
            assertFalse(java.lang.reflect.Modifier.isAbstract(
                CapacityPlanningServiceApplicationSimpleTest.class.getModifiers()));
        }
    }

    @Nested
    @DisplayName("Capacity Planning AI Operations Tests")
