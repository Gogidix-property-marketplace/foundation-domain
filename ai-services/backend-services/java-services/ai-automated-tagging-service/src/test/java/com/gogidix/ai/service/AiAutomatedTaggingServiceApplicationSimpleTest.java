...
@SpringBootTest
@ActiveProfiles("test")
@DisplayName("AiAutomatedTaggingServiceApplicationSimpleTest")
public class AiAutomatedTaggingServiceApplicationSimpleTest {

    private static final String SERVICE_NAME = "ai-automated-tagging-service";
    private static final String ARTIFACT_ID = "ai-automated-tagging";
    ...
    class ServiceStructureTests {
        ...
        void applicationClassShouldBeLoadable() {
            assertDoesNotThrow(() -> {
                Class.forName("com.gogidix.ai.service.AiAutomatedTaggingServiceApplicationSimpleTest");
            });
        }
    }
    ...
    class IntegrationTests {
        ...
        void shouldStartApplicationContext() {
            assertDoesNotThrow(() -> {
                SpringApplication.run(AiAutomatedTaggingServiceApplicationSimpleTest.class);
            });
        }
