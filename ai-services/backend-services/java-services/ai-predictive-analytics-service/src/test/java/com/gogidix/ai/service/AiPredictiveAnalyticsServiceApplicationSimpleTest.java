...
@SpringBootTest
@ActiveProfiles("test")
@DisplayName("AiPredictiveAnalyticsServiceApplicationSimpleTest")
public class AiPredictiveAnalyticsServiceApplicationSimpleTest {

    private static final String SERVICE_NAME = "ai-predictive-analytics-service";
    private static final String ARTIFACT_ID = "ai-predictive-analytics";
    ...
    class ServiceStructureTests {
        ...
        void applicationClassShouldBeLoadable() {
            assertDoesNotThrow(() -> {
                Class.forName("com.gogidix.ai.service.AiPredictiveAnalyticsServiceApplicationSimpleTest");
            });
        }
    }
    ...
    class IntegrationTests {
        ...
        void shouldStartApplicationContext() {
            assertDoesNotThrow(() -> {
                SpringApplication.run(AiPredictiveAnalyticsServiceApplicationSimpleTest.class);
            });
        }
