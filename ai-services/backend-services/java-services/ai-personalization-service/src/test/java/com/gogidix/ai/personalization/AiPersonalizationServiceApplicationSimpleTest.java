package com.gogidix.ai.personalization;
...
/**
 * Simple unit tests for ai-personalization-service
 * These tests provide basic coverage without Spring context
 */
class AiPersonalizationServiceApplicationSimpleTest {
    ...
    class ServiceStructureTests {
        ...
        void servicePackageShouldBeCorrect() {
            Package pkg = Package.getPackage("com.gogidix.ai.personalization");
            assertNotNull(pkg, "Package should exist");
            assertEquals("com.gogidix.ai.personalization", pkg.getName());
        }

        @Test
        @DisplayName("Test class should be instantiatable")
        void testClassShouldBeInstantiatable() {
            AiPersonalizationServiceApplicationSimpleTest test = new AiPersonalizationServiceApplicationSimpleTest();
        ...
        void testClassShouldHaveCorrectPackage() {
            assertEquals("com.gogidix.ai.personalization",
                AiPersonalizationServiceApplicationSimpleTest.class.getPackage().getName());
        }
        ...
        void testClassShouldNotBeAbstract() {
            assertFalse(java.lang.reflect.Modifier.isAbstract(
                AiPersonalizationServiceApplicationSimpleTest.class.getModifiers()));
        }
    }

    @Nested
    @DisplayName("AI Personalization Service Operations Tests")
