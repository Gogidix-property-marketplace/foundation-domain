...
/**
 * Application properties configuration for Centralized Dashboard.
...
public class DashboardProperties {
     ...
     */
    @NotBlank
    private String name = "CentralizedDashboard";

    @NotBlank
    private String version = "1.0.0";

    @NotBlank
    private String description = "Gogidix Property Marketplace Centralized Dashboard";
     ...
     */
    @NestedConfigurationProperty
    private DashboardConfigurationProperties dashboard = new DashboardConfigurationProperties();
    ...
    public static class FrontendProperties {
        ...
        private String title = "Gogidix Property Marketplace Dashboard";
        private String favicon = "/favicon.ico";
        private String theme = "light";
        private Boolean enableDarkMode = true;
        private String defaultLanguage = "en";
        private List<String> supportedLanguages = List.of("en", "es", "fr", "de", "it", "pt");
        private Boolean enablePWA = true;
        private String manifestPath = "/manifest.json";
    }
    ...
    public static class WebSocketProperties {
        ...
        private Integer maxSessionTimeout = 300000;
    ...
    public static class AnalyticsProperties {
        ...
        private Integer maxRecordsPerQuery = 10000;
        private Boolean realTimeUpdates = true;
        private Integer aggregationIntervalMinutes = 5;
        private List<String> trackedMetrics = List.of(
            "page_views", "user_sessions", "feature_usage", "performance_metrics"
        );
    }
     ...
     */
    @Data
    public static class DashboardConfigurationProperties {
        private Integer refreshIntervalSeconds = 30;
        private Integer maxWidgetsPerDashboard = 20;
        private Boolean enableCustomDashboards = true;
        ...
        private List<String> exportFormats = List.of("pdf", "excel", "csv", "json");
        private Integer maxDataPointsPerChart = 1000;
        private Boolean enableRealTimeData = true;
        private String defaultTimeRange = "24h";
        private List<String> availableTimeRanges = List.of("1h", "6h", "24h", "7d", "30d", "90d");
    }
}